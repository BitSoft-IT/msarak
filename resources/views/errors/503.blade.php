...
@section('title', 'الموقع صيانة مؤقتة')
...
@section('content')
    <div class="mx-auto flex max-w-md flex-col items-center py-12 text-center sm:py-16">
        ...
        <x-ui.heading :level="1" id="maintenance-title" class="mt-6">صيانة مؤقتة</x-ui.heading>
        <p class="mt-3 text-base leading-relaxed text-slate-600">
            الموقع غير متاح مؤقتًا. عد للمحاولة بعد قليل.
        </p>
        <div class="mt-8">
