...
**الملف:** `04-system-contracts.md`
**الحالة:** معتمدة للتنفيذ بعد مراجعة H-03
**آخر تحديث:** 2026-09-21
**مرجع نموذج التقييم:** `docs/04-assessment/question_bank_specification.md` — v1.2  
...
### مصدر الحقيقة لعقود التقييم

تعتمد عقود رحلة التقييم في هذه الوثيقة نموذج التقييم v1.2.

المرجع المعتمد لسلوك الإجابة والحساب هو:

`docs/04-assessment/question_bank_specification.md`

ويعتمد النموذج الحالي:

- `response_type = option | none | cannot_judge`
- `primary_option_id`
- تقييمات اختيارية من `-2` إلى `+2`
- حد أدنى 15 موقفًا صالحًا لإنتاج النتيجة

أي تعليمات أقدم تستخدم Closest/Least أو نموذجًا مختلفًا لا تستخدم في التنفيذ الحالي.
